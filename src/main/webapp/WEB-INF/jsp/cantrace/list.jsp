    ...
    <div class="col-xs-12">
        <div class="form-inline" style="padding: 5px;">
            <div class="form-group">
                <label for="serachdept">部门名称</label>
                <input type="text" class="form-control" id="serachdept" placeholder="请输入部门名称">
            </div>&nbsp;&nbsp;
...
<script type="text/javascript">
    ...
    $('#table').bootstrapTable({
            ...
            url: '/contract/findContractByList',
            columns: [{
                field: 'contractId',
                title: 'Id',
                visible: false
    ...
    function operateFormatter(value, row, index) {
        return [
            '<button id="tableProduct" type="button" class="tableProduct btn bg-primary">货物</button>&nbsp;&nbsp;',
