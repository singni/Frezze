...
<div class="page-content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">新增附件</h3>
        </div>
        <div class="panel-body">

            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal" role="form" action="/contract/addExtCproduct" method="post">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="productNo" placeholder="输入货物描述" name="productNo"
                                               class="col-xs-10 col-sm-5"/>
                                    </div>
                        ...
                        <input type="hidden" id="contractProductId" name="contractProductId">
...
<script>
    ...
    $(function () {
        ...
        window.parent.document.getElementById("myiframe").setAttribute("scrolling", "auto");
        $("#contractProductId").val( getUrlParam());
    ...
    $('#table').bootstrapTable({
            ...
            url: '/contract/findExtCproductByList',
            columns: [{
                field: 'extCproductId',
                title: 'id',
                visible: false
            ...
            'click .talbeDelete': function (event, value, row, index) {
                var id = row.extCproductId;

                $.post("/contract/deleteExtCproduct/"+id, {})
